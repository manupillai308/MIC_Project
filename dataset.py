...
class TrainSet(torch.utils.data.Dataset):
    def __init__(self, args):
        ...
        img_path = []
        with open("/home/ma293852/Desktop/code/MIC/Assignment 2/dataset/0_train.txt") as f:
            for folder_name in f.readlines():
                img_path += glob.glob(os.path.join(self.img_root, f"BRATS_{int(folder_name):03d}", "*.jpg"))

        label_path = []
        with open("/home/ma293852/Desktop/code/MIC/Assignment 2/dataset/0_train.txt") as f:
            for folder_name in f.readlines():
                label_path += glob.glob(os.path.join(self.label_root, f"BRATS_{int(folder_name):03d}", "*.jpg"))

        for i in tqdm(range(len(img_path)), desc='Loading training dataset'):
...
class ValidSet(torch.utils.data.Dataset):
    def __init__(self, args):
        ...
        with open("/home/ma293852/Desktop/code/MIC/Assignment 2/dataset/0_test.txt") as f:
            for folder_name in f.readlines():
                self.img_path += glob.glob(os.path.join(self.img_root, f"BRATS_{int(folder_name):03d}", "*.jpg"))
        with open("/home/ma293852/Desktop/code/MIC/Assignment 2/dataset/0_test.txt") as f:
            for folder_name in f.readlines():
                self.label_path += glob.glob(os.path.join(self.label_root, f"BRATS_{int(folder_name):03d}", "*.jpg"))
